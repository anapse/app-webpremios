...
# Automatiza el build del frontend para VPS y despliegue a Nginx

Write-Host "🚀 Iniciando despliegue al VPS..." -ForegroundColor Green

# 1. Hacer build del frontend específico para VPS (sin /app-webpremios/)
Write-Host "📦 Construyendo frontend para VPS..." -ForegroundColor Yellow
...
Write-Host "🎉 ¡Despliegue al VPS completado!" -ForegroundColor Green
Write-Host "💡 Las rutas ahora son limpias (sin /app-webpremios/)" -ForegroundColor Cyan
